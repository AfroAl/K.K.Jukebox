...
public class ACWWActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acww);
        //Toolbar toolbar = findViewById(R.id.toolbar_acww);
        //setSupportActionBar(toolbar);

        sunny = findViewById(R.id.sunny_acww);
        rainy = findViewById(R.id.rainy_acww);
        snowy = findViewById(R.id.snowy_acww);

        ac = findViewById(R.id.ac_acww);
        acww = findViewById(R.id.acww_acww);
        accf = findViewById(R.id.accf_acww);
        acnl = findViewById(R.id.acnl_acww);
        ...
        stop = findViewById(R.id.pause_acww);
        playPause = 1;
        weatherRadio = findViewById(R.id.weather_acww);
